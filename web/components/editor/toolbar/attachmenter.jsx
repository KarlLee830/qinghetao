...
function AttachmentToolbarer(props) {
  let file = null;
  ...
  return (
    <div className={styles['dvditor-attachment-toolbarer']}>
      {/*!showAll && (
        <>
          <div className={styles['dvditor-attachment-toolbar__left']}>
            {props.category}
          </div>
		  <div className={styles['dvditor-attachment-toolbar__right'],styles.show} onClick={handleToggle}>
	  ...
	  {!showAll && (
	    <>
		  <div className={styles['dvditor-attachment-toolbarer__left']}>
			{props.category}
		  </div>
		  {/*<div className={styles['dvditor-attachment-toolbarer__right'], styles.show}>
			{currentIcon && props.permission[action] && <Icon name={currentIcon} size="20" />}
				<MenuFoldOutlined style={{ fontSize: '22px'}}/>
		  </div>*/}
		</>
	  )}
      <div className={styles['dvditor-attachment-toolbarer__inner']} style={styl}>
        <div className={styles['dvditor-attachment-toolbarer__left']}>
          {icons()}
          <DZQPluginCenterInjectionPolyfill
            className={pluginInfo => getIconCls({ type: pluginInfo?.pluginName })}
...
AttachmentToolbarer.propTypes = {
  onAttachClick: PropTypes.func,
  category: PropTypes.element,
};

export default AttachmentToolbarer;
